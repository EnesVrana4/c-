...
using SocialApp.Models;//// vendos emrin e Projektit qe je duke bere psh"LinqTest" kujtohu

///posht var bilder = webapplication.createbuilder(args)  shto keto gjeraaaa/////
